...
- (void)setupSubviews
{
    ...
    _webviewVC = [[WZOHWebViewController alloc] init];
    _webviewVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"测试web"
                                                          image:[UIImage imageNamed:@"tabbar_setting"]
                                                  selectedImage:[UIImage imageNamed:@"tabbar_settingHL"]];
    _webviewVC.tabBarItem.tag = 3;
    _webviewVC.tabBarItem.accessibilityIdentifier = @"webTesting";
    _webviewVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [self unSelectedTapTabBarItems:_webviewVC.tabBarItem];
    [self selectedTapTabBarItems:_webviewVC.tabBarItem];
    
    
    self.viewControllers = @[_chatListVC, _contactsVC, _settingsVC, _webviewVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
